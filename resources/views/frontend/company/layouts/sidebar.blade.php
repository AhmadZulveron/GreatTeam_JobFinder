<div class="quixnav" style="background: #1C2D4D;">
    <div class="quixnav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="/perusahaan-dashboard" aria-expanded="false">
                <i class="icon icon-single-04"><img src="/images/dashboard.png" height="16px" alt=""></i><span class="nav-text">Dashboard</span></a></li>
            <li class="nav-label">Apps</li>
            <li><a class="has-arrow" href="/perusahaan-lowongan"><i class="icon icon-chart-bar-33"><img src="/images/add.png" height="16px" alt=""></i><span class="nav-text">Lowongan</span></a>
                {{-- <ul aria-expanded="false">
                    <li><a href="/perusahaan-lowongan">Tambah Lowongan</a></li>
                    <li><a href="#">Lowongan Dihapus</a></li>
                </ul> --}}
            </li>
            <li><a class="has-arrow" href="pemohon"><i class="icon icon-app-store"><img src="/images/pemohon.png" height="16px" alt=""></i><span class="nav-text">Pemohon</span></a>
                {{-- <ul aria-expanded="false">
            ...
            <li><a class="has-arrow" href="#"><i class="icon icon-app-store"><img src="/images/caripelamar.png" height="16px" alt=""></i><span class="nav-text">Cari Pelamar</span></a>
                {{-- <ul aria-expanded="false">
                    <li><a href="#">Cari Pelamar</a></li>
                    <li><a href="pemohon" aria-expanded="false">Pemohon</a></li>
                    <li><a href="#">Diterima</a></li>
